...
<?php if (isset($_SESSION['msg']) && $_SESSION['msg'] != "" && isset($_SESSION['tipo_msg']) && $_SESSION['tipo_msg'] != "") { ?>
    <div align="center">
        <div style="font-size: 1.2em; margin-top: 25px; width:400px;" class="alert alert-<?= $_SESSION['tipo_msg']; ?>" align="center">
...
<form method="post" action="../Controllers/ClienteController.php?Action=Add" id="cadastro_cliente">
    <div class="container" align="center">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="nome" id="nome" maxlength="100" required autofocus>
            <br>
        </div>
        <div class="col-md-3">
